<template>
	<view class="phoneAuthentication">
		...
		<view class="phoneAuthentication_main">
			<view class="banner">
				<image class="img" src="../../static/privacy/banner@1x.jpg" mode=""></image>
			</view>
			<view class="phoneAuthentication_center">
				<view class="phoneAuthentication_header">
					<view class="title">
						手机实名认证
					</view>
				...
				<view class="phoneAuthentication_from">
                    <view class="phoneAuthentication_input">
						<view class="left">
                    ...
                    <!-- <view class="phoneAuthentication_input">
						...
						<input class="uni-input srinput" placeholder="输入身份证号" />
					</view> -->
					<view class="phoneAuthentication_input">
						<view class="left">
                    ...
                    <view class="phoneAuthentication_input phoneAuthentication_puzz">
						<view class="left">
				...
				<view class="phoneAuthentication_footer">
					<view class="hint">
						<view class="title">
					...
					<view class="num">剩余可试用：<text>{{count}}</text>次</view>
                    <suspendButton :haibaoObj='haibaoObj' @event='event' :refreshUrl="'phoneAuth'"></suspendButton>
				</view>
	...
	export default {
            ...
            uni.getStorage({
                ...
                success: function(res) {
                    ...
                    if (res.data && res.data != undefined && res.data != "undefined") {
                        that.Phone = res.data;
                        that.$getRequestCount(72,res.data)
                            .then((response) => {
		...
		methods: {
			...
			generate(){
                ...
                that.loading=true
				wx.request({
					url: that.$reUrl+"/console/trialRequest.html?f=identityVerifyMobile",
					data: {
                        phone: that.mobile,
                        name: that.name,
					...
					success(ress) {
                        ...
                        if(ress.data.respCode=='000'){
                            ...
                            that.$getRequestCount(72,that.Phone)
                                .then((response) => {
                                    that.count=response.data.count
...
<style lang="scss">
	.phoneAuthentication {
		...
		.phoneAuthentication_main {
			...
			.phoneAuthentication_center {
				position: relative;
				z-index: 2;
				.phoneAuthentication_header {
					height: 240rpx;
				...
				.phoneAuthentication_from {
                    ...
                    .phoneAuthentication_puzz{
                        // border-bottom:none;
                        height: 80rpx;
                    }
				}

				.phoneAuthentication_footer {
					margin: 0 20rpx;
					margin-top: 36rpx;
